...
class Appointment(db.Model):
    ...
    appointment_type = db.Column(db.String(50))  # "In-person" or "Video Call"
...
class HealthRecordFile(db.Model):
    ...
    # Link to health record category/type
    record_type = db.Column(db.String(200), nullable=False)  # e.g., "Medical Check Up Report"
    
    filename = db.Column(db.String(300), nullable=False)
    file_path = db.Column(db.String(300), nullable=False)
    file_size = db.Column(db.String(20))  # e.g., "2 MB"
    file_type = db.Column(db.String(20))  # e.g., "pdf", "jpg", "png"
